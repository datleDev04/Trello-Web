export const mockData = {
  board: {
    ...
    columns: [
      ...
      // xử lí bug kéo thả khi column bị rỗng không thể kéo card sang
      // FE tạo 1 card đặc biệt, không liên quan tới BE
      // card này sẽ được ẩn
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
        title: 'bug empty column',
        cardOrderIds: ['column-id-04-placholder-card'],
        cards: [
          { _id: 'column-id-04-placholder-card',
            boardId: 'board-id-01',
